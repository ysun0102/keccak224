/**
We give some codes to verify the correctness of the found preimages. 
This file generates the messages M, M_{58}, M_{59}, M_{60} and outputs their digests, produced by 3-round keccak-224. The implementations of Keccak-f permutation, which is the function 'KeccakP1600Round', as well as other functions, are copied from the package 'XKCP-master' (almost all the funcitons come from the file: /lib/low/KeccakP-1600/KeccakP-1600-reference.c), which is available at https://keccak.team/software.html.

Usage of this program:
1. complie this file with:
...
Remark: The number of bits given in M_{58}, M_{59}, and M_{60} are 2304, so the values of the last 2304 - inputBitLenXX bits are useless, and will be updated by the paddings. The padded messages are as follows.
M_{58} with padding:
	0x3867ED3B88A48506,0xFFFFFFFFFFFFFFFF,0xDD2D9BE5549AE517,0xFFFFFFFFFFFFFFFF,0x0,
	0x97CBA3B4524267F6,0x0,0xF607605E0D17724B,0x0,0x0,
	0x59E591785BB04788,0x0,0x87A44FB877A61A6E,0x0,0x0,
	0xF649DFF78156A578,0x0,0xAC8EB4032E2B8D32,

	0xC84C8045515BF0C7,0x61FD4B2BBE00140E,0x00B252887E479E1D,0x4CA8454ECB4032EC,0x0980778FEAFC137D,
	0x1B4109C0E732BD96,0x820D1264F56CED03,0xE3A15B12575B72A2,0x1A068D85C2B37FE0,0x5DCA726A8F294970,
	0xD41129BE08A68BD4,0x301DD29F5E9BE657,0x98A7904810694A48,0xB3E8566CE50EA6AA,0x48C3E4DEB3ADD02B,
	0x853EF9C96DC6F02D,0xA72B40AD1F31A630,0xAAD47114F4750BFC.

M_{59} with padding:
	0x35EF68DC35F1E5EB,0xFFFFFFFFFFFFFFFF,0xA1D249A40996BB5F,0xFFFFFFFFFFFFFFFF,0x0,
	0x42F30B16705F6ECA,0x0,0x26A9E432AE324F66,0x0,0x0,
	0xBBB37F56A6F28967,0x0,0xA9590D7698444C80,0x0,0x0,
	0xCCAF1C9CE35C0246,0x0,0x2E22A0E03FE0B8B9,

	0xCCADB05484618913,0xCB72585A10CF1D24,0x5142B6082D69F648,0x55FF802052E9AFA7,0x5002434225118309,
	0x4673F9FF53CF4651,0x422091CBEE6ED26C,0x2CED676FB523B95D,0xAF5FD173FA98BE32,0x1BB7489625D2A58A,
	0x1B58D9FB91AD563D,0xD2F304B902CD182E,0x9F519823A0C16E4D,0xA54F438AFE22755C,0x8C39E80475FCDBB0,
	0xB908F9B8CD448A94,0x63EF7F66EA21A245,0xD0A64F63C7333027.

M_{60} with padding:
	0xCBB53657E0A66871,0xFFFFFFFFFFFFFFFF,0x7537C0597B751AA7,0xFFFFFFFFFFFFFFFF,0x0,
	0xA27C4639BB60DFF0,0x0,0x561C6D11D6A8DE58,0x0,0x0,
	0x22DF18C837CF65DB,0x0,0x37C8309A24DD20E7,0x0,0x0,
	0x4B1668A66C09D25A,0x0,0x14E39DD28900E418,

	0xB5B27127B16157CE,0x1D9CDF75F80E635D,0xD2024BC09980F06E,0x43E0D61A974E2162,0xD3E8E4C133283C19,
	0x291ADC10C38952D3,0x0D79C02584D59EB5,0x5B6EDBF95FBBD637,0xFDF01822DC1C43A3,0x516EB953B657C03F,
	0x8C83A4CFE46AFA61,0x8EF91ECCAD2D5731,0x3510F4267D8A4D55,0x13A2BACDCE43348D,0x0A22C2B955093C72,
	0x8836257614188A4E,0xAFBB582F7829B0EB,0xECF33EA53BEC3299.
*/
...
int main(int argc, const char * argv[]) { 
	...
	UINT64 *hash_1,*hash_60,*hash_59,*hash_58; 
